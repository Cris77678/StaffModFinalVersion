...
public class PlayerProfileGui extends SimpleGui {
    ...
    private void build(SimpleGui parent) {
        ...
        setSlot(15, new GuiElementBuilder(Items.ANVIL)
            ...
            .addLoreLine(Component.literal("§7Abre el panel de acciones para este jugador."))
            .setCallback((idx, type, action, gui) -> {
                this.close();
                staff.sendSystemMessage(Component.literal("§eSelecciona una acción en el menú principal."));
            }).build());
