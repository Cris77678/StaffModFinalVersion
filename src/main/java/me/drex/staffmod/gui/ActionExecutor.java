...
public class ActionExecutor {
    ...
    // ───── UNBAN — BUG #3 FIX ─────
    // ORIGINAL: llamaba isOffline() → un baneado nunca está online → siempre cancelaba
    // FIX: opera directo sobre DataStore con UUID, sin requerir que el jugador esté online
    public static void unban(ServerPlayer staff, UUID targetUuid, String targetName) {
        ...
        AuditLogManager.log(staff.getName().getString(), "UNBAN", targetName, "");
    }

    // Sobrecarga para compatibilidad cuando el jugador SÍ está online
